...
const RecuperoPassword = () =>
{
    ...
    return(
        <Flex flexDirection='column' width='100vw' height='100vh' background='linear-gradient(299.92deg, #514689 18.26%, #EF426F 117.31%)' alignItems='center' justifyContent='center'>
            <Flex flexDirection='column' height='500px' backgroundColor='white' borderRadius='38px' padding='5.5rem 3rem 0 3rem'>
                ...
                <FormProvider {...methods}>
                    ...
                    <Spacer width={'20px'} height={'20px'} />
                    <ButtonForm onClick={handleClickAccess} backgroundColor='#EF426F' fontWeight={theme.fontWeights.bold} fontSize={theme.fontSizes.sm} _hover={{bg: '#d73e65'}}>Recupera password</ButtonForm>
                </FormProvider>
                <a style={{textAlign:'center', fontWeight: theme.fontWeights.bold, fontSize: theme.fontSizes.xss, color: '#514689', marginTop:'1.8rem'}} onClick={handleClickLogin}>Torna al login</a>
            </Flex>
        </Flex>
    )
}
