...
const Filter = ({show, showFilters, isFilterUsed, children, handleFilters}: Props) =>
{
    return <Flex direction='column' display={show ? 'none' : 'block'}>
            <ButtonForm marginTop='4rem' marginBottom='1rem' width='fit-content' onClick={handleFilters} backgroundColor={isFilterUsed? '#514689b3' : darkModePalette.pink100} _hover={{bg: darkModePalette.pink70}} fontSize={theme.fontSizes.xxs}>
                Filtri
            </ButtonForm>
            {
                showFilters ? 
